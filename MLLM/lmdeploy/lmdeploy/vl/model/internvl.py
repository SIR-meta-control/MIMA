...
# import InternVL.internvl_chat
import sys
import os
# sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', '..', '..', 'intervl_chat/internvl')))
# print(sys.path)
# from InternVL.internvl_chat.work_dirs.ours_mini_4b_finetune_2.configuration_internvl_chat import InternVLChatConfig
...
class InternVLVisionModel(VisonModel):
    ...
    def build_model(self):
        ...
        with init_empty_weights():
            # config = AutoConfig.from_pretrained("/fuxi_team14/users/haoyanghe/codes/jszn/InternVL/models/Ours_Mini-InternVL-4B/models--OpenGVLab--Mini-InternVL-Chat-4B-V1-5/snapshots/6f97087daec17e4b033d4d846c0b64c09c4268cd").save_pretrained("/fuxi_team14/users/haoyanghe/codes/jszn/InternVL/models/Ours_Mini-InternVL-4B/models--OpenGVLab--Mini-InternVL-Chat-4B-V1-5/snapshots/6f97087daec17e4b033d4d846c0b64c09c4268cd/.")
            config = AutoConfig.from_pretrained(self.model_path,
                                                trust_remote_code=True)
            # config = InternVLChatConfig.from_pretrained("/fuxi_team14/users/haoyanghe/codes/jszn/InternVL/internvl_chat/work_dirs/ours_mini_4b_finetune_2",
            #                                     trust_remote_code=True)
            # config = AutoConfig.from_pretrained("/fuxi_team14/users/haoyanghe/codes/jszn/InternVL/internvl_chat/work_dirs/ours_mini_4b_finetune_1",
            #                                     trust_remote_code=True)
            # print(config)
